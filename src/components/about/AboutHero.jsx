      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2 lg:px-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-0 h-[280px] w-[48%] overflow-hidden rounded-[30px] border-[8px] border-background bg-white shadow-2xl"
          >
            <img
              src={mochaBloomKeychain}
              alt="Mocha Bloom macrame keychain"
